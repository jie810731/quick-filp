...
if __name__ == '__main__':
    ...
    #     print("query ids = {}".format(token_ids_query))
    #     params = {
    ...
    #     index += offset_count
    useful_data = {'9': 9999.0, '766': 12.9, '747': 13.5, '763': 17.5, '765': 30.0, '720': 25.0, '723': 25.2, '734': 734.0, '692': 22.0, '663': 27.0, '683': 27.5, '689': 100.0, '64': 16.4, '629': 23.0, '595': 14.6, '598': 26.0, '559': 25.0, '581': 49.9, '532': 25.99, '541': 69.042, '524': 19.99, '508': 22.22, '486': 38.0, '448': 22.0, '454': 49.0, '434': 12.5, '440': 30.0, '397': 23.0, '403': 99.0, '37': 12.89, '355': 100.0, '289': 22.0, '301': 88.0, '268': 900.0, '238': 13.5, '206': 14.5, '201': 22.5, '191': 88.88, '152': 100.0, '130': 42.69, '10': 13.8, '115': 30.0}
    useful_data = [
        {
            "token_id" :'9',
            "price":123
    ...
    useful_data.sort(key=lambda x: x['price'], reverse=False)
